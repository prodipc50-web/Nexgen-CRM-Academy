    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="admission-terms-a4-frame w-full h-full flex flex-col justify-between border-2 border-teal-950 rounded-2xl print:rounded-lg p-3.5 sm:p-5 print:p-2.5 bg-white relative">
            {/* Header Section */}
            <div className="border-b-2 border-teal-950 pb-2 print:pb-1 mb-2 print:mb-1.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <NexgenLogo variant="crest" size={46} />
                  <div>
                    <h1 className="text-xl sm:text-2xl print:text-[17px] font-black text-teal-950 uppercase tracking-tight leading-none">
                      {instituteName}
                    </h1>
                    <p className="text-[11px] print:text-[8.5px] text-slate-700 font-bold tracking-wide mt-0.5">
                      {STUDENT_TERMS_HEADER_SUBTITLE}
                    </p>
                    <p className="text-[10px] print:text-[8px] text-slate-600 font-medium">
                ...
                <div className="text-right shrink-0">
                  <div className="bg-teal-950 text-white text-[10px] print:text-[8.5px] font-black uppercase px-2.5 py-0.5 rounded tracking-wider inline-block">
                    OFFICIAL TERMS & CONDITIONS
                  </div>
                  <p className="text-[9.5px] print:text-[7.5px] text-teal-900 font-bold mt-0.5">
              ...
              <div className="mt-2 pt-1.5 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-1 print:flex-row print:items-center">
                <h2 className="text-sm sm:text-base print:text-[11px] font-black text-teal-950 tracking-tight uppercase flex items-center space-x-1.5">
                  <ShieldCheck className="w-4 h-4 text-teal-800 inline shrink-0" />
                  <span>STUDENT TERMS & CONDITIONS (ছাত্র আচরণবিধি ও নীতিমালা)</span>
                </h2>
                <span className="text-[10.5px] print:text-[8px] font-bold text-teal-900 bg-teal-50 border border-teal-300 px-2.5 py-0.5 rounded-full inline-block self-start sm:self-auto">
                  {STUDENT_TERMS_NOTICE}
                </span>
              </div>
              ...
              {(studentName || courseName || studentCode) ? (
                <div className="mt-1.5 bg-slate-50 print:bg-teal-50/40 p-2 rounded-lg border border-slate-200 print:border-teal-200 grid grid-cols-2 sm:grid-cols-4 print:grid-cols-4 gap-1.5 text-xs print:text-[8.5px]">
                  <div>
                    <span className="text-slate-500 text-[10px] print:text-[7.5px] block">Student Name:</span>
                    <span className="font-bold text-slate-950">{studentName || '—'}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 text-[10px] print:text-[7.5px] block">Student ID:</span>
                    <span className="font-mono font-bold text-teal-950">{studentCode || '—'}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-slate-900">{batchNumber || dateStr}</span>
                  </div>
                </div>
              ) : (
                <div className="mt-1.5 bg-slate-50 print:bg-teal-50/30 px-2.5 py-1 rounded-md border border-slate-200 print:border-teal-200/60 flex items-center justify-between text-[10.5px] print:text-[8px]">
                  <span className="text-teal-950 font-bold">
                    Official Institutional Regulation & Student Code of Conduct • NexGen Computer Academy
                  </span>
                  <span className="text-slate-500 font-mono text-[10px] print:text-[7.5px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 print:grid-cols-2 gap-2 print:gap-1.5 text-xs print:text-[8.5px] print:leading-snug">
              {effectiveTerms.map(item => (
                ...
                >
                  ...
                  <div className="bg-teal-950 text-white px-2.5 py-1 print:px-2 print:py-0.5 flex items-center space-x-1.5 shrink-0">
                    ...
                    <div className="flex-1 flex items-baseline justify-between overflow-hidden">
                      <span className="font-black text-xs print:text-[9px] tracking-tight truncate">
                        {item.numberBn}. {item.titleEn}
                      </span>
                      <span className="text-[10px] print:text-[8px] text-teal-200 font-bold ml-1 shrink-0">
                        ({item.titleBn})
                      </span>
                    </div>
                  </div>
                  ...
                  {/* Clause Content Body */}
                  <div className="p-2.5 print:p-1.5 text-[11px] print:text-[8.5px] leading-relaxed print:leading-snug text-slate-800 flex-1 flex flex-col justify-between bg-slate-50/30 print:bg-white">
            ...
            <div className="mt-2.5 print:mt-1.5 border-2 border-teal-900/40 bg-teal-50/50 rounded-xl print:rounded-md p-2.5 print:p-1.5">
              <div className="flex items-start space-x-2">
                ...
                />
                <div className="hidden print:flex w-3.5 h-3.5 border-2 border-teal-950 rounded bg-white items-center justify-center shrink-0 mt-0.5">
                  <span className="text-teal-950 text-[10px] font-black leading-none">✓</span>
                </div>
                <label htmlFor="termsDeclarationCheckbox" className="cursor-pointer select-none flex-1">
                  <span className="font-bold text-xs print:text-[8.5px] text-teal-950 block leading-snug">
                    {effectiveDeclaration}
                  </span>
                  <span className="text-[10.5px] print:text-[7.5px] text-teal-800 mt-0.5 block font-medium">
            ...
            <div className="pt-3 print:pt-1.5 mt-2 print:mt-1 border-t-2 border-slate-300 grid grid-cols-2 gap-8 print:gap-4 text-center text-xs print:text-[8.5px]">
              <div>
                ...
                <p className="text-[9px] print:text-[7px] text-slate-500">শিক্ষার্থীর স্বাক্ষর ও তারিখ ({dateStr})</p>
              </div>

              <div>
                <div className="h-6 print:h-5 border-b border-teal-950 w-48 mx-auto mb-1 flex items-end justify-center pb-0.5">
                  <span className="text-xs print:text-[9.5px] font-serif italic font-black text-teal-950">
                    {signatoryName}
                  </span>
                </div>
                ...
                <p className="text-[9px] print:text-[7px] text-teal-800 font-bold">
            ...
            <div className="mt-2 print:mt-0.5 pt-1 border-t border-slate-200 flex items-center justify-between text-[9px] print:text-[7.5px] text-slate-500 font-medium">
