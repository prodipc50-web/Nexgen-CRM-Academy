    ...
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center flex-wrap gap-2">
          <button
            onClick={() => {
              window.dispatchEvent(new CustomEvent('open-bulk-id-cards'));
            }}
            className="flex items-center space-x-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-800 border border-indigo-300 text-xs font-bold px-3 py-2 rounded-xl shadow-2xs transition-colors"
            title="Generate and print batch-wise PVC ID cards and Admit cards"
          >
            <Layers className="w-4 h-4 text-indigo-600" />
            <span>Bulk ID & Admit Cards (আইডি কার্ড প্রিন্ট)</span>
          </button>
